$(function(){
  "use strict";
      ...
      $('.btnspinner').on("touchend touchstart mousedown", function(e){  // "mousedown" は長押し用、 "click" は1個づつ用。
        if(arySpinnerCtrl['interval']) return false;
          ...
          //クリックは単一の処理に留める
          if(e.type == "touchend"){ // イベントが "mousedown" "click" の内 "click" の方だと下記の処理。(※ 1個づつ増減処理をしたい時)
              // スピナーの値を更新
              spinnerCal();
              // 必要な要素の取得
